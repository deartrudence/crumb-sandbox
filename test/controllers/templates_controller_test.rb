...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { campaign_id: @template.campaign_id, template_name: @template.template_name } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { campaign_id: @template.campaign_id, template_name: @template.template_name } }
